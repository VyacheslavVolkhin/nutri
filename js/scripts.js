document.addEventListener("DOMContentLoaded", function() {
	...
	//slider cases
	const swiperSliderCases = new Swiper('.slider-cases .swiper', {
		loop: true,
		slidesPerView: 1,
		spaceBetween: 0,
		autoHeight: true,
		...
		autoplay: false,
		navigation: {
			nextEl: '.btn-action-ico.ico-arrow.ico-arrow-next.button-slider-cases-next',
			prevEl: '.btn-action-ico.ico-arrow.ico-arrow-prev.button-slider-cases-prev',
		},
